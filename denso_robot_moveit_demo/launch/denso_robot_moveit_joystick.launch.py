...
# Configuration arguments
    ...
    # Include the teleop-launch.py launch file and pass the 'joy_config' argument
    ...
    denso_robot_moveit_joystick_node = Node(
        package='denso_robot_moveit_demo',
        executable='denso_robot_moveit_joystick',
        output='screen',
        parameters=[
            moveit_cpp_yaml_file_name,
            robot_description,
    ...
    return LaunchDescription(declared_arguments + [denso_robot_moveit_joystick_node,])
